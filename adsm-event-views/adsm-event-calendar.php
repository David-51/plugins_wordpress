...
function adsm_render_calendar_grid( $month = null, $year = null ) {
    ...
    $month = isset($_GET['ec-month']) ? intval($_GET['ec-month']) : date('n');
    $year  = isset($_GET['ec-year'])  ? intval($_GET['ec-year'])  : date('Y');
    ...
    <div class="adsm-calendar-nav">
        <a class="adsm-cal-btn adsm-cal-today" href="<?php echo esc_url($base_url. '?calendar=1'); ?>">Ce mois-ci</a>
        <a class="adsm-cal-btn adsm-cal-prev" href="<?php echo esc_url($base_url . '?ec-month=' . $prev_month . '&ec-year=' . $prev_year . "&calendar=1"); ?>">&laquo; Mois précédent</a>
        <a class="adsm-cal-btn adsm-cal-next" href="<?php echo esc_url($base_url . '?ec-month=' . $next_month . '&ec-year=' . $next_year . "&calendar=1"); ?>">Mois suivant &raquo;</a>
